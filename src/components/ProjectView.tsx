    ...
    return (
        <div ref={containerRef} className="animate-fade-in">
            ...
            <div className="pt-12 border-t border-gray-100 flex justify-between items-center">
                {prevProject ? (
                    <button onClick={() => handleNavigate(prevProject.id)} className="group cursor-pointer">
                    ...
                    <button onClick={handleBack} className="group cursor-pointer">
                ...
                {nextProject ? (
                    <button onClick={() => handleNavigate(nextProject.id)} className="group text-right cursor-pointer">
                    ...
                    <button onClick={handleBack} className="group text-right cursor-pointer">
                        <span className="text-subtle text-[10px] uppercase tracking-widest block mb-1">Back</span>
                        <span className="text-sm group-hover:underline underline-offset-4 decoration-gray-300">All Work →</span>
                    </button>
                )}
