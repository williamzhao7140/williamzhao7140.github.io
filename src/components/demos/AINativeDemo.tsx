            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="relative group">
                    ...
                    <div className="relative flex items-center bg-white rounded-lg p-1">
                        ...
                        />
                        <button className="px-3 py-1.5 bg-gray-50 hover:bg-gray-100 text-xs font-medium rounded-md text-ink transition-colors border border-gray-200 cursor-pointer">
                            Generate
                        </button>
                    </div>
                </div>
                ...
                <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm relative overflow-hidden">
                    ...
                    <div className="flex justify-end">
                        <button
                            ...
                            className="text-xs font-medium text-purple-600 hover:text-purple-700 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                        >
