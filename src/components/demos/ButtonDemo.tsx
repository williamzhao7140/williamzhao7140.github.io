        ...
        <div className="flex flex-col gap-8 items-start">
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-4 items-center">
                    <button className="px-4 py-2 bg-ink text-white rounded-md text-sm font-medium hover:opacity-90 transition-opacity cursor-pointer">
                        Button
                    </button>
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-4 items-center">
                    <button className="px-4 py-2 bg-gray-100 text-ink rounded-md text-sm font-medium hover:bg-gray-200 transition-colors cursor-pointer">
                        Button
                    </button>
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-4 items-center">
                    <button className="px-4 py-2 text-ink rounded-md text-sm font-medium hover:bg-gray-50 transition-colors cursor-pointer">
                        Button
                    </button>
